...
interface MaterialCardProps {
    ...
    onShowQR: (material: Material) => void
}

export default function MaterialCard({ material, onLink, onShowScans, onShowQR }: MaterialCardProps) {
    ...
    return (
        <div className="group relative bg-white dark:bg-[#111] rounded-3xl border border-gray-200 dark:border-white/5 overflow-hidden transition-all duration-500 hover:shadow-2xl hover:shadow-emerald-500/10 hover:-translate-y-1">
            {/* Image Header */}
            <div
            ...
            >
                ...
                <button
                    ...
                    className="absolute top-4 right-4 z-20 size-10 rounded-full bg-black/40 backdrop-blur-md border border-white/10 flex items-center justify-center text-white hover:bg-[#0df2a2] hover:text-black transition-all"
                    title="Toon QR Code"
                >
