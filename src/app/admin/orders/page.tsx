import { getAdminOrders } from '../products/actions'
import OrdersManagementClient from './OrdersManagementClient'
import { AlertCircle } from 'lucide-react'

export const metadata = {
    title: 'Bestellingen | Superadmin',
    description: 'Beheer alle shop bestellingen en leveringen'
}
...
export default async function AdminOrdersPage() {
    ...
    return (
        <div className="max-w-6xl mx-auto">
            <OrdersManagementClient initialOrders={result.data || []} />
        </div>
    )
}
